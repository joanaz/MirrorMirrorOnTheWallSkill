...
app.showImages = function(images, searchTerm) {
	return new Promise(((resolve, reject) => {
		app.setup();
  		var update = {
  		  "images": images,
...
app.changeModule = function(moduleName, turnOn) {
	return new Promise(((resolve, reject) => {
		app.setup();
		var update = {
